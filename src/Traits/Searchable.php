...
namespace DieZeeL\SphinxScout\Traits;

use DieZeeL\SphinxScout\Classes\Attributes;
use DieZeeL\SphinxScout\Classes\Builder;
...
trait Searchable
{
    ...
    public function getSearchableAttributes()
    {
        if ($this->searchableAttributes === null)
            return $this->searchableAttributes = new Attributes($this);
    ...
    public function toSearchableArray()
    {
        ...
        $attrs = $this->getSearchableAttributes();
        return $attrs->toSearchableArray();
     ...
     * @return array
     */
    public function searchableCasts()
    {
        return [];
    }
